...
// Created via this command line: PAC modelbuilder build --outdirectory D:\GithubEnlist\dynamics365-customerservice-wem-samples\src\3rdPartyIntegration\Export\TimeOffRequests\Proxies\ --settingsTemplateFile D:\GithubEnlist\dynamics365-customerservice-wem-samples\src\3rdPartyIntegration\Export\TimeOffRequests\Proxies\builderSettings.json
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace TimeOff.SampleClient
{
	...
	public partial class XRMServiceContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="TimeOff.SampleClient.msdyn_TimeOffType"/> entities.
		/// </summary>
		public System.Linq.IQueryable<TimeOff.SampleClient.msdyn_TimeOffType> msdyn_TimeOffTypeSet
		{
			get
			{
				return this.CreateQuery<TimeOff.SampleClient.msdyn_TimeOffType>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="TimeOff.SampleClient.msdyn_WemRequest"/> entities.
		/// </summary>
		public System.Linq.IQueryable<TimeOff.SampleClient.msdyn_WemRequest> msdyn_WemRequestSet
		{
			get
			{
				return this.CreateQuery<TimeOff.SampleClient.msdyn_WemRequest>();
			}
		}
	}
